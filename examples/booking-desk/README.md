...
5. `manual-workflow-test-script.md` to validate the full markdown-only workflow
...
| `manual-workflow-test-script.md` | Manual end-to-end test script for the markdown-only CircuitScout workflow. | Validating intake, transfer, discovery, fit scoring, contact verification, outreach drafting, approval stops, inbox triage, and follow-up planning with fictional data only. | Use the listed skills in sequence and stop before any external action. |
